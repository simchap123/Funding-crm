...
export function SigningPage({
  ...
  const handleAutoFill = () => {
    ...
    for (const field of myFields) {
      ...
      let value = "";
      const signerName = contactData?.name || data.name;
      const signerEmail = contactData?.email || data.email;
      if (field.type === "date") {
        ...
        value = contactData?.company || data.contactCompany || "";
      } else if (field.type === "title") {
        value = contactData?.title || data.contactTitle || "";
      } else if (field.type === "initials") {
        value = generateInitials(signerName);
